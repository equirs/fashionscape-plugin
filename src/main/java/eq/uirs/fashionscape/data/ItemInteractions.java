...
public class ItemInteractions
{
	...
	public static final Set<Integer> BAD_ITEM_IDS = ImmutableSet.of(
		...
		25960, 25961, 25969, 25971, 25983, 25985, 25987, 25989, 25973, 26217, 26237, 26239, 26241, 26243, 26245, 26376,
		26378, 26380, 26526, 26567, 26686, 26687, 26688, 26689, 26690, 26691, 26692, 26693, 26694, 26695, 26698, 26699,
	...
	public static final Set<Integer> HAIR_HELMS = ImmutableSet.of(
		...
		26937, 26963, 26967, 27035, 27123, 27141, 27143, 27145, 27147, 27149, 27151, 27153, 27155
	);
	...
	static
	{
		...
		// ItemID.HEAVY_BALLISTA_OR (in case of removal from cache)
		WEAPON_TO_IDLE.put(26712, IdleAnimationID.BALLISTA);
		...
		// ItemID.ELDER_MAUL_OR (in case of removal from cache)
		WEAPON_TO_IDLE.put(27100, IdleAnimationID.ELDER_MAUL);
