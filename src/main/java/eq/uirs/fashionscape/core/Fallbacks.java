...
public class Fallbacks
{
	...
	static
	{
		...
		FEM_KITS.put(KitType.ARMS, ArmsKit.REGULAR.getKitId(1));
	 ...
	 */
	public int getKit(KitType slot, Integer gender, boolean detectUnknown)
	{
		...
		{
			eventBus.post(new KnownKitChanged(true, slot));
		}
		return result;
	}
}
